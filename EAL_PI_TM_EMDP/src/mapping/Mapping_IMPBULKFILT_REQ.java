...
public class Mapping_IMPBULKFILT_REQ extends AbstractTransformation{
	...
	public void execute(InputStream is, OutputStream os)
		...
		try {
			...
			xstream.processAnnotations(MT_IMPBULKFILT_REQ.class);
			MT_IMPBULKFILT_REQ req = (MT_IMPBULKFILT_REQ) xstream.fromXML(is);
